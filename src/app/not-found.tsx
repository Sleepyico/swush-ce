...
import { IconEyeSearch, IconHome } from "@tabler/icons-react";
  ...
  return (
    <ExternalLayout>
      <section className="relative w-full max-w-xl overflow-hidden rounded-2xl border bg-background/60 p-8 shadow-lg backdrop-blur">
        ...
        <div className="pointer-events-none absolute -inset-1 -z-20 bg-gradient-to-b from-primary/20 via-transparent to-transparent blur-2xl" />
